...
public class LanguageConfig {
	...
	"FlyMod:This Mod let you &6fly Up &fand &6Down faster &fthan normal;You can &6disable &fcreative &6fly swim;&4If you want to move fast forward, enable SpeedMod","InfoMod:Displays some Information;- &6Looking Direction;- &6Fps;- &6Coordinates;- &6WorldAge","SpeedMod:Let you &6move faster forward","LightMod:Disable &6Shadows and Darkness","RecipeMod:Shows you possible crafting Results;- &6Load your own 3*3 Recipes!;- &6See item crafting- pattern (&4beta&6)","TimeMod:Controll the &6Time!;&6- Make it Stop;&6- Make it faster/slower;&6- Add and substract Time","MobHighLighter:Marks Entities;&6- Change marks in your config;&4- This only affect the Renderer not the Game!","OreHighLighter:Marks Blocks;&6- Change marks in your config","PathMod:Get your moved way marked;&6- Never get lost in caves anymore!","RangeMod:Manupulate the World with;&6- Range Building;&6- Range Picking;&6- Range Breaking",
	"Main.updateMSG:&4A new Lite-Zombe Version is avaible: <urlversion>","Main.choosepos:Choose the &6Position;of the &6Info-Textline",
	...
	"OreHighLighter.toggle:Enable &6OreHighLighter","OreHighLighter.radius:Set the &6Radius for &6OreHighLighter","OreHighLighter.chooseonkey:Choose the the &6key; to enable","OreHighLighter.showinfo:Displays the &6Radius",
